...
public class SpriteSheet
{
    ...
    public void Render(GameRenderer renderer, (int X, int Y) dest, double angle = 0.0, Point rotationCenter = new(), double sizeMultiplier = 1.0)
    {
        int frameWidth = (int)(FrameWidth * sizeMultiplier);
        int frameHeight = (int)(FrameHeight * sizeMultiplier);
