...
namespace TheAdventure.Models
{
    ...
    {
        private bool _hitByExplosion = false; // Add a flag to track if the player has been hit by an explosion

        public void SetHitByExplosion(bool hit)
        {
            _hitByExplosion = hit;
        }
        ...
        public void Reset()
        {
            Position = (100, 100); // Example starting position
            SetState(PlayerState.Idle, PlayerStateDirection.Down); // Reset state
                                                                   // Reset other necessary player state variables
        }
    }
}