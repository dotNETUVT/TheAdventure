...
namespace TheAdventure.Models
{
    public class PlayerObject : RenderableGameObject
    {
        ...
        public bool HasRedPowerUp { get; private set; }
        public bool HasBluePowerUp { get; private set; }
        public bool HasYellowPowerUp { get; private set; }
        ...
        public void CollectPowerUp(PowerUpType powerUpType)
        {
            switch (powerUpType)
            {
                ...
                case PowerUpType.Yellow:
                    HasYellowPowerUp = true;
                    break;
            }
        }

        public bool CanDestroyObstacle(ObstacleType obstacleType)
        {
            return (obstacleType == ObstacleType.Red && HasRedPowerUp) ||
                   (obstacleType == ObstacleType.Blue && HasBluePowerUp) ||
                   (obstacleType == ObstacleType.Yellow && HasYellowPowerUp);
        }
    }
}
