...
namespace TheAdventure
{
    public unsafe class InputLogic
    {
        ...
        public bool ProcessInput()
        {
            ...
            // Check arrow keys
            if (_keyboardState[(int)Scancode.ScancodeUp] == 1 || _keyboardState[(int)KeyCode.W] == 1)
                up = 1.0;
            else if (_keyboardState[(int)Scancode.ScancodeDown] == 1 || _keyboardState[(int)KeyCode.S] == 1)
                down = 1.0;

            if (_keyboardState[(int)Scancode.ScancodeLeft] == 1 || _keyboardState[(int)KeyCode.A] == 1)
                left = 1.0;
            else if (_keyboardState[(int)Scancode.ScancodeRight] == 1 || _keyboardState[(int)KeyCode.D] == 1)
                right = 1.0;
