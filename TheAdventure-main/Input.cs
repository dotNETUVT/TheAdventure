...
namespace TheAdventure
{
    public unsafe class Input
    {
        ...
        public bool IsLeftPressed()
        {
            ...
            return _keyboardState[(int)KeyCode.Left] + _keyboardState[(int)KeyCode.A] > 0;
        }
        
        public bool IsRightPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Right] + _keyboardState[(int)KeyCode.D] > 0;
        }
        
        public bool IsUpPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Up] + _keyboardState[(int)KeyCode.W] > 0;
        }
        
        public bool IsDownPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Down] + _keyboardState[(int)KeyCode.S] > 0;
        }

        public bool IsShiftPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.LShift] + _keyboardState[(int)KeyCode.RShift] > 0;
        }
