...
namespace TheAdventure
{
    public unsafe class Input
    {
        ...
        public bool IsLeftPressed()
        {
            ...
            return _keyboardState[(int)KeyCode.Left] == 1 || _keyboardState[(int)KeyCode.A] == 1;
        }

        public bool IsRightPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Right] == 1 || _keyboardState[(int)KeyCode.D] == 1;
        }

        public bool IsUpPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Up] == 1 || _keyboardState[(int)KeyCode.W] == 1;
        }

        public bool IsDownPressed()
        {
            ReadOnlySpan<byte> _keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
            return _keyboardState[(int)KeyCode.Down] == 1 || _keyboardState[(int)KeyCode.S] == 1;
        }
